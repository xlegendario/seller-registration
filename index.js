...
const {
  ...
  // Optional: for DM helper (we now only really use DISCORD_INVITE_URL)
  ORDER_FORM_URL = 'https://airtable.com/appHoMBqKDPnVfWJY/pagBT948BlVapOzc5/form',
  DISCORD_INVITE_URL = 'https://discord.gg/aE4j7T8a',
} = process.env;
...
app.post('/notify-existing-seller', async (req, res) => {
  ...
  try {
    ...
    lines.push(
      '',
      'If you think this is a mistake, something doesn’t look right or you need help with something, just join the server above and contact support.',
      '',
